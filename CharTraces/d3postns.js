							...
							.append('svg:path')
								...
								.attr('d', function(d) { 
									...
									//return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny) + ' l 4 0 l -8 0'; 
										if (num == 0) {
											return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny) + ' l 4 0 l -4 6 l -4 -6 z'; 
										} else if (num == 1) {
											return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l 4 0 l 0 4 l -2 0 l -2 4 l -2 -4 l -2 0 l 0 -4 l 4 0 z';
										} else if (num == 2) {
											//return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l 2 0 l -1 3 l 1 0 l -1 3 l -2 -3 l 1 0 l -1 -3 l 2 0 z';
											return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l 2 0 l 2 2 l 0 2 l -4 4 l -4 -4 l 0 -2 l 2 -2 l 2 0 z';
										} else if (num == 3) {
											//return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l -2 -2 l 4 4 l -2 2 l -2 -2 l -4 -4 z';
											//return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l 2 0 l 0 6 l -2 -4 l -2 -2 l 2 0 z';
											return 'M ' + (d.x - minx)*(w-margin*2)/(maxx-minx) +' '+ (d.y - miny)*(h-margin*2)/(maxy-miny)+ ' l 4 0 l -2 4 l 2 0 l -4 4 l -4 -4 l 2 0 l -2 -4 l 4 0 z';
										}
      								}) 
...
function getAllData(folder) {
	...
	var listoffiles = ["GRAVEDIGGER1", "GRAVEDIGGER2", "HAMLET", "HORATIO"];
	for (var i = 0; i < listoffiles.length; i++) {
		generateData(folder+listoffiles[i]+".csv", i);
	}
}
